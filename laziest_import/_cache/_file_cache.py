...
from .. import _config
from ._dir import _cleanup_cache_if_needed, _get_cache_dir, _get_cache_size
...
def _init_file_cache() -> None:
    ...
    elif _config._DEBUG_MODE:
        if cache:
            logging.info(f"[laziest-import] Cache outdated for {caller_path}, will rebuild")
        else:
