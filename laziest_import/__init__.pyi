...
class LazyProxy:
    ...
    def __getattr__(self, name: str) -> LazyModule | LazySymbol | Any: ...
    def __dir__(self) -> list[str]: ...
...
def get_module(alias: str) -> ModuleType | None: ...
...
def get_version(alias: str) -> str | None: ...
...
def search_module(name: str) -> str | None: ...
def search_class(class_name: str) -> tuple[str, Any] | None: ...
...
def get_symbol_preference(symbol: str) -> str | None: ...
...
def validate_aliases(aliases: dict[str, str] | None = None) -> dict[str, list[str]]: ...
def validate_aliases_importable(
    aliases: dict[str, str] | None = None,
) -> dict[str, dict[str, Any]]: ...
def export_aliases(path: str | None = None, include_categories: bool = True) -> str: ...
...
def enable_retry(
    max_retries: int = 3, retry_delay: float = 0.5, modules: set[str] | None = None
) -> None: ...
...
def clear_file_cache(file_path: str | None = None) -> int: ...
...
def set_cache_config(
    symbol_index_ttl: int | None = None,
    stdlib_cache_ttl: int | None = None,
    third_party_cache_ttl: int | None = None,
...
def set_pip_index(url: str | None) -> None: ...
...
def which(symbol_name: str, module_hint: str | None = None) -> SymbolLocation | None: ...
...
def wait_for_index(timeout: float | None = None) -> bool: ...

# ============== RC Config ==============

def load_rc_config() -> dict[str, Any]: ...
def get_rc_value(key: str, default: Any = None) -> Any: ...
def create_rc_file(path: str | None = None, template: bool = True) -> str: ...
def get_rc_info() -> dict[str, Any]: ...
def reload_rc_config() -> None: ...
def save_rc_config(config: dict[str, Any], path: str | None = None) -> None: ...
...
class BenchmarkRunner:
    ...
    def benchmark_function(
        self, name: str, func: Callable, iterations: int | None = None
    ) -> BenchmarkResult: ...
    def benchmark_import(
        self, module_name: str, iterations: int | None = None
    ) -> BenchmarkResult: ...
...
def __getattr__(name: str) -> LazyModule | LazySymbol | Any: ...
