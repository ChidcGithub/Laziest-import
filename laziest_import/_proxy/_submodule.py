...
class LazySubmodule:
    ...
    __slots__ = ("_attr_name", "_cached_module", "_full_name", "_parent", "_submodule_cache")

    def __init__(
        self, full_name: str, parent: Union["LazyModule", "LazySubmodule"], attr_name: str
    ):
    ...
    def _get_module(self) -> Any:
        ...
        try:
            ...
            c._IMPORT_STATS.module_times[full_name] = elapsed
            ...
            if c._DEBUG_MODE:
                logging.info(
                    f"[laziest-import] Loaded submodule '{full_name}' in {elapsed * 1000:.2f}ms"
                )
